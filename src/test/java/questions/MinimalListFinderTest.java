...
public class MinimalListFinderTest {
    @Test public void testStub() {
        MinimalListFinder classUnderTest = new MinimalListFinder();
    }
    ...
    @Test public void testZeroCreatures() throws IOException, AvmException {
    	...
    	Set<List<Attribute>> expectedResult = new HashSet<List<Attribute>>();
    	expectedResult.add( new ArrayList<Attribute>() );
    	Set<List<Attribute>> observedResult = MinimalListFinder.minimalLists( ctt );
